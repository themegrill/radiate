<?php
/**
 * Radiate customizer class for theme customize sanitizes.
 *
 * Class Radiate_Customizer_FrameWork_Sanitizes
 *
 * @package    ThemeGrill
 * @subpackage Radiate
 * @since      Radiate 3.0.0
...
/**
 * Radiate customizer class for theme customize callbacks.
 *
 * Class Radiate_Customizer_FrameWork_Sanitizes
 */
class Radiate_Customizer_FrameWork_Sanitizes {
	...
	public static function sanitize_typography( $typography_args, $setting ) {
		...
		if ( isset( $typography_args['subsets'] ) ) {
			...
			$subsets        = Radiate_Fonts::get_google_font_subsets();
