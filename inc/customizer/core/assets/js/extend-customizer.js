		...
		wp.customize.bind(
			...
			function () {
				...
				wp.customize.section.each(
					function ( section ) {
						if (
							'radiate_section' !== section.params.type ||
				...
				wp.customize.panel.each(
					function ( panel ) {
						if (
							'radiate_panel' !== panel.params.type ||
		...
		wp.customize.Panel = wp.customize.Panel.extend(
			{
				...
				isContextuallyActive : function () {
					...
					if ( 'radiate_panel' !== this.params.type ) {
		...
		wp.customize.Section = wp.customize.Section.extend(
			{
				attachEvents         : function () {
					...
					if (
						'radiate_section' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'radiate_section' !== this.params.type ) {
				...
				wp.customize.control.each(
					function ( ctrl, i ) {
						...
						if ( description.length ) {
							...
							li_wrapper.append( '<i class="radiate-control-tooltip dashicons dashicons-editor-help" title="' + tooltip + '"></i>' );
						}
					}
				);
			}
 ...
 *
 * Currently used for the Radiate Upseel section only.
 */
(
	function ( $, api ) {
