...
class Radiate_Customize_Base_Option {

	public function __construct() {

		// Register the customize panels, sections and controls.
		add_filter( 'radiate_customizer_options', array( $this, 'register_options' ), 10, 2 );
	...
	public function get_section_description( $args ) {
		...
		// Description.
		$content = '<div class="radiate-section-description">';
...
return new Radiate_Customize_Base_Option();
