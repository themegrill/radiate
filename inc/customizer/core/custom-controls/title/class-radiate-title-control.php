 ...
 * Class Radiate_Title_Control
 */
class Radiate_Title_Control extends Radiate_Customize_Base_Additional_Control {
	...
	protected function content_template() {
        ...
        <div class="radiate-title-wrapper">
