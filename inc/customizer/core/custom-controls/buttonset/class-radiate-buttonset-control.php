 ...
 *
 * Class Radiate_Buttonset_Control
 */
class Radiate_Buttonset_Control extends Radiate_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="buttonset">
			...
			<div class="buttonset-inner">
				...
				<label for="{{ data.id }}{{ key }}" class="radiate-buttonset">
					{{{ data.choices[ key ] }}}
				</label>
			</div>
			<# } #>
