 ...
 *
 * Class Radiate_Radio_Image_Control
 *
 * @package    ThemeGrill
 * @subpackage Radiate
 * @since      Radiate 3.0.0
 ...
 * Class Radiate_Radio_Image_Control
 */
class Radiate_Radio_Image_Control extends Radiate_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'radiate-radio-image';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="image image-col-{{{ data.image_col }}}">
			...
			<label for="{{ data.id }}{{ key }}" {{{ data.labelStyle }}} class="radiate-radio-image">
