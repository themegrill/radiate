 ...
 * Class Radiate_Custom_Control
 */
class Radiate_Custom_Control extends Radiate_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="radiate-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="radiate-custom-links">
