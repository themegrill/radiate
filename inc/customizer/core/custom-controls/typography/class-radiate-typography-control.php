 ...
 *
 * Class Radiate_Typography_Control
 *
 * @package    ThemeGrill
 * @subpackage Radiate
 * @since      Radiate 3.0.0
 ...
 * Class Radiate_Typography_Control
 */
class Radiate_Typography_Control extends Radiate_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'radiate-typography';
	...
	public function enqueue() {
		...
		$google_font_subsets = Radiate_Fonts::get_google_font_subsets();
		$localize_scripts    = array(
			'standardfontslabel' => esc_html__( 'Standard Fonts', 'radiate' ),
			'googlefontslabel'   => esc_html__( 'Google Fonts', 'radiate' ),
		...
		if ( ! empty( $custom_fonts ) ) {
			$localize_scripts['customfontslabel'] = esc_html__( 'Custom Fonts', 'radiate' );
		...
		wp_localize_script(
			...
			'RadiateCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'radiate-customize-controls',
			'RadiateCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = Radiate_Fonts::get_font_variants();
	...
	public function get_system_fonts() {
		...
		$standard_fonts       = Radiate_Fonts::get_system_fonts();
	...
	public function get_google_fonts() {
		...
		$google_fonts          = Radiate_Fonts::get_google_fonts();
		$font_variants         = Radiate_Fonts::get_font_variants();
		$foogle_fonts__subsets = Radiate_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = Radiate_Fonts::get_custom_fonts();
	...
	public function to_json() {
		...
		$this->json['languages']   = Radiate_Fonts::get_google_font_subsets();
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family">
				<span class="customize-control-title"><?php esc_html_e( 'Family', 'radiate' ); ?></span>
				<div class="radiate-field-content">
					<select {{{ data.inputAttrs }}} id="radiate-font-family-{{{ data.id || data.name }}}"></select>
				</div>
			</div>

			<# if ( data.default['font-weight'] ) { #>
			<div class="font-weight">
				<span class="customize-control-title"><?php esc_html_e( 'Weight', 'radiate' ); ?></span>
				<div class="radiate-field-content">
					<select {{{ data.inputAttrs }}} id="radiate-font-weight-{{{ data.id || data.name }}}"></select>
				</div>
			</div>
			<# } #>
			...
			<div class="subsets">
				<span class="customize-control-title"><?php esc_html_e( 'Subset(s)', 'radiate' ); ?></span>
				<div class="radiate-field-content">
					<select {{{ data.inputAttrs }}} id="radiate-subsets-{{{ data.id || data.name }}}" multiple>
			...
			<div class="font-size">
				<span class="customize-control-title"><?php esc_html_e( 'Size', 'radiate' ); ?></span>
				...
				<div class="desktop control-wrap active">
					<input type="number"
					       id="radiate-font-size-desktop-{{{ data.id || data.name }}}"
					       data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="number"
					       id="radiate-font-size-tablet-{{{ data.id || data.name }}}"
					       data-device="tablet"
							<# if ( data.value['font-size'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="number"
					       id="radiate-font-size-mobile-{{{ data.id || data.name }}}"
					       data-device="mobile"
							<# if ( data.value['font-size'] ) { #>
			...
			<div class="line-height">
				<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'radiate' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="number"
					       id="radiate-line-height-desktop-{{{ data.id || data.name }}}"
					       data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="number"
					       id="radiate-line-height-tablet-{{{ data.id || data.name }}}"
					       data-device="tablet"
							<# if ( data.value['line-height'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="number"
					       id="radiate-line-height-mobile-{{{ data.id || data.name }}}"
					       data-device="mobile"
							<# if ( data.value['line-height'] ) { #>
			...
			<div class="letter-spacing">
				<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'radiate' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="number"
					       id="radiate-letter-spacing-desktop-{{{ data.id || data.name }}}"
					       data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="number"
					       id="radiate-letter-spacing-tablet-{{{ data.id || data.name }}}"
					       data-device="tablet"
							<# if ( data.value['letter-spacing'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="number"
					       id="radiate-letter-spacing-mobile-{{{ data.id || data.name }}}"
					       data-device="mobile"
							<# if ( data.value['letter-spacing'] ) { #>
			...
			<div class="font-style">
				<span class="customize-control-title"><?php esc_html_e( 'Style', 'radiate' ); ?></span>
				<div class="radiate-field-content">
					<select {{{ data.inputAttrs }}} id="radiate-font-style-{{{ data.id || data.name }}}">
						<option value="normal"
						<# if ( 'normal' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Normal', 'radiate' ); ?></option>
						<option value="italic"
						<# if ( 'italic' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Italic', 'radiate' ); ?></option>
						<option value="oblique"
						<# if ( 'oblique' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Oblique', 'radiate' ); ?></option>
						<option value="initial"
						<# if ( 'initial' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Initial', 'radiate' ); ?></option>
						<option value="inherit"
						<# if ( 'inherit' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Inherit', 'radiate' ); ?></option>
					</select>
				</div>
			</div>
			<# } #>
			...
			<div class="text-transform">
				<span class="customize-control-title"><?php esc_html_e( 'Transform', 'radiate' ); ?></span>
				<div class="radiate-field-content">
					<select {{{ data.inputAttrs }}} id="radiate-text-transform-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'radiate' ); ?></option>
						<option value="capitalize"
						<# if ( 'capitalize' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Capitalize', 'radiate' ); ?></option>
						<option value="uppercase"
						<# if ( 'uppercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Uppercase', 'radiate' ); ?></option>
						<option value="lowercase"
						<# if ( 'lowercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Lowercase', 'radiate' ); ?></option>
						<option value="initial"
			...
			<div class="text-decoration">
				<span class="customize-control-title"><?php esc_html_e( 'Decoration', 'radiate' ); ?></span>
				<div class="radiate-field-content">
					<select {{{ data.inputAttrs }}} id="radiate-text-decoration-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'radiate' ); ?></option>
						<option value="underline"
						<# if ( 'underline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Underline', 'radiate' ); ?></option>
						<option value="overline"
						<# if ( 'overline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Overline', 'radiate' ); ?></option>
						<option value="line-through"
						<# if ( 'line-through' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Line Through', 'radiate' ); ?></option>
						<option value="initial"
