<?php
/**
 * Radiate customizer base control class for theme customize options.
 *
 * Class Radiate_Customize_Base_Control
 *
 * @package    ThemeGrill
 * @subpackage Radiate
 * @since      Radiate 3.0.0
...
/**
 * Radiate customizer base control class.
 *
 * Class Radiate_Customize_Base_Control
 */
class Radiate_Customize_Base_Control {
...
return new Radiate_Customize_Base_Control();
