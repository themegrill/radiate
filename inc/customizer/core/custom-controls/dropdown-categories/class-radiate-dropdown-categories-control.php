 ...
 *
 * Class Radiate_Dropdown_Categories_Control
 *
 * @package    ThemeGrill
 * @subpackage Radiate
 * @since      Radiate 3.0.0
 ...
 * Class Radiate_Dropdown_Categories_Control
 */
class Radiate_Dropdown_Categories_Control extends Radiate_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'radiate-dropdown-categories';
