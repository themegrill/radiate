...
/**
 * Radiate_Demo_Importer Class.
 */
class Radiate_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'radiate' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'radiate' ), __( 'Demo Importer', 'radiate' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
