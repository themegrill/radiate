 ...
 */
function radiate_customm_css_migrate() {
	if ( get_option( 'radiate_custom_css_transfer' ) ) {
		return;
	}
	$theme_custom_css = get_theme_mod( 'radiate_custom_css', '' );
